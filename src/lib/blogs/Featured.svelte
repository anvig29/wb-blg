<script>
    ...
    window.location.href = 'https://chic-sfogliatella-d32d4a.netlify.app/';
  }
  ...
  <section class="featured" style="--color: {post.color}" in:fly={{ y: 10, duration: 500 }}>
	<div class="featured-wrapper">
	  <div class="image">
		<img src="https://wallpapercave.com/wp/wp6469960.jpg" alt="Your Image" class="img" />
	  </div>
	  <div class="text-block">
		...
		<a id="title" href="https://chic-sfogliatella-d32d4a.netlify.app/" on:click|preventDefault={openArticle} data-sveltekit-preload-data="hover">
		  <h2>The Star in Your Sky</h2>
		</a>
		...
		<div class="actions-bottom">
		  <div class="author">
			...
			<div class="right">
			  <div class="half-container">
				<span id="author-name">Anonymousvi</span>
			  </div>
			  <div class="half-container">
		  ...
		  <a href="https://chic-sfogliatella-d32d4a.netlify.app/" on:click|preventDefault={openArticle}>
			<span class="read-article">
			  <button class="btn c2a">
		  ...
		  <div class="actions">
			...
			<button title="Share" on:click={share(post.slug, post.title)} id="share">
